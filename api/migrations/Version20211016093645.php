...
final class Version20211016093645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accommodation (id INT UNSIGNED AUTO_INCREMENT NOT NULL, room_id INT NOT NULL, status INT UNSIGNED NOT NULL, check_in_at DATETIME NOT NULL, check_out_at DATETIME NOT NULL, book_at DATETIME DEFAULT NULL, rooms_amount INT UNSIGNED NOT NULL, people_amount INT UNSIGNED NOT NULL, INDEX IDX_2D38541254177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE guest (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, surname VARCHAR(255) DEFAULT NULL, nationality VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, document_id VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, roles JSON DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE accommodation ADD CONSTRAINT FK_2D38541254177093 FOREIGN KEY (room_id) REFERENCES room (id)');
