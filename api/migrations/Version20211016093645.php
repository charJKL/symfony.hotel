...
final class Version20211016093645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accommodation (id INT UNSIGNED AUTO_INCREMENT NOT NULL, status INT UNSIGNED NOT NULL, check_in_at DATETIME NOT NULL CONSTRAINT CHECK (check_in_at > DATE_ADD(CURRENT_TIMESTAMP, INTERVAL -1 HOUR)), check_out_at DATETIME NOT NULL, book_at DATETIME DEFAULT NULL, rooms_amount INT UNSIGNED NOT NULL, people_amount INT UNSIGNED NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
